    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ayudante1ero', models.ForeignKey(db_column='ayudante1er', on_delete=django.db.models.deletion.DO_NOTHING, related_name='ayudante1er', to='erp.operario', verbose_name='Primer ayudante')),
                ('ayudante2do', models.ForeignKey(db_column='ayudante2do', on_delete=django.db.models.deletion.DO_NOTHING, related_name='ayudante2do', to='erp.operario', verbose_name='Segundo ayudante')),
                ...
                ('maquinista', models.ForeignKey(db_column='maquinista', on_delete=django.db.models.deletion.DO_NOTHING, related_name='maquinista', to='erp.operario', verbose_name='Maquinista')),
                ...
                ('supervisor', models.ForeignKey(db_column='supervisor', on_delete=django.db.models.deletion.DO_NOTHING, related_name='supervisor', to='erp.operario', verbose_name='Supervisor')),
            ],
            options={
